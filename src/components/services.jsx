...
const features = [
    {
        title: "Haematology",
        icon: TestTube,
        description: "Complete blood count and other haematology tests.",
    ...
    },
    {
        title: "Microbiology",
        icon: Microscope,
        description: "Bacterial, fungal and other microbial analyses for reliable diagnosis.",
        codeSnippet: "Culture\\nSensitivity\\nMicroscopy",
        imagePosition: "left",
    },
    {
        title: "Immunology",
        icon: Activity,
        description: "Hormone assays, immunoglobulins and other immune system tests.",
    ...
    },
    {
        title: "Serology",
        icon: BeakerIcon,
        description: "Infectious disease screening and antibody testing.",
    ...
    },
    {
        title: "Urinalysis",
        icon: Droplet,
        description: "Routine and specialist urine analysis for clear clinical insight.",
